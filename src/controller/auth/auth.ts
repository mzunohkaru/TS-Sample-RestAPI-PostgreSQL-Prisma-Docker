...
export class AuthController {
  ...
  public verifyToken = async (
    ...
    try {
      ...
      try {
        accessToken = this.authService.extractTokenFromHeader(authHeader);
        ...
        if (
          ...
          try {
            ...
            newTokens = await this.authService.refreshToken(refreshToken);

            // 新しいアクセストークンを検証してユーザー情報を取得
            const newPayload = this.authService.verifyAccessToken(
